...
const ZAPIEN_BUSINESS = {
  ...
  followup: {
    ativo: true,
    horas: 24,
    mensagem: 'Oi! Passando para saber se você quer ver o Zapien funcionando no seu negócio. Posso indicar o plano mais adequado ou ajudar você a começar o teste grátis de 7 dias.',
  },
  produtos: [
    {
  ...
  regras: [
    'Na primeira mensagem para um lead novo, use: “Oi! Sou a Zapi, assistente virtual do Zapien. Eu posso mostrar como a plataforma ajuda no atendimento e nas vendas pelo WhatsApp. Você vende produtos, serviços ou ambos?” Não finja ser humana.',

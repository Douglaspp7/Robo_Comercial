...
if (PRODUCTION_MODE) {
  const REQUIRED = [
    'OPENAI_API_KEY', 'WHATSAPP_VERIFY_TOKEN', 'SESSION_SECRET', 'DATA_ENCRYPTION_KEY',
  ];
  ...
  const SECRET_VARS = [
    'OPENAI_API_KEY', 'WHATSAPP_VERIFY_TOKEN', 'SESSION_SECRET', 'CSRF_SECRET',
    ...
    'GOOGLE_CLIENT_SECRET', 'MELHOR_ENVIO_PLATFORM_TOKEN',

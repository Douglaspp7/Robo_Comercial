...
if [ -n "$HAS_KEY" ]; then
  # O seed também funciona como migração: se o tenant já existir, atualiza o
  # conteúdo comercial sem precisar da senha. Para tenant novo, o próprio script
  # valida a senha de criação e informa claramente o que está faltando.
